...
public interface ExpenseRepository extends JpaRepository<Expense, Long> {
    ...
    @Query("select e from Expense e join fetch e.category c where e.transactionDate between :begin and :end and c.toCheck = true")
    List<Expense> getBudgetPlan(@Param("begin") LocalDate begin, @Param("end") LocalDate end);
}
